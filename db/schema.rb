...
ActiveRecord::Schema.define(version: 2019_12_17_085159) do

  create_table "authers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "publisher"
    t.date "birthdate"
    t.string "first_name"
    t.string "last_name"
